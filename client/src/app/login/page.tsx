    ...
    <div className="flex min-h-screen flex-1 items-center justify-center bg-neutral-50 px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-[22px] font-bold leading-[1.2] tracking-[-0.015em] text-neutral-900">
              Bienvenido de nuevo
            </h1>
            <p className="mt-1 text-[13px] leading-[1.45] text-neutral-500">
        ...
        <div className="rounded-2xl border border-neutral-100 bg-surface-white p-8 shadow-[0_1px_2px_rgba(17,24,39,0.04),0_12px_32px_-16px_rgba(17,24,39,0.12)]">
          <form className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-[12px] leading-[1.3] tracking-[0.01em] text-primary-600 hover:text-primary-700"
                >
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-[11px] uppercase leading-[1.3] tracking-[0.01em] text-neutral-500">
              o continúa con
            </span>
            <div className="h-px flex-1 bg-neutral-100" />
          </div>
        ...
        <p className="mt-6 text-center text-[12px] leading-[1.3] tracking-[0.01em] text-neutral-500">
